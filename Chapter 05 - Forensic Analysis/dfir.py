...
"""
Description:
    This is a rudimentary Digital Forensics and Incident Response (DFIR) for checking the content of 
    the directory and the checksums of their files.
...
class Dfir:
    ...
    def compare_finterprints(self) -> bool:
        """Compares the fingerprints (checksum) of all the Python files in the current directory with what was generated before and shows if the results are ok or they don't match
        """
