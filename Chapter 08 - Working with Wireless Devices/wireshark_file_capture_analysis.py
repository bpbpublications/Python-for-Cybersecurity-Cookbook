...
"""
Description:
    Uses pyshark and Wireshark CLI Utility (tshark) to perform a live capture on an interface and save the 
    content to a .pcap file. After that perform analysis of the captured packets.
