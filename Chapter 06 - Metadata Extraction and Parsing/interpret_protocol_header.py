...
"""
Description:
    Uses pyshark and Wireshark CLI Utility (tshark) to perform a capture on an interface and then shows the 
    fields of the 'ip' protocol header so that we can interpret them.

Author:
    Nishant Krishna

Chapter:
    Chapter 06 - Metadata Extraction and Parsing
